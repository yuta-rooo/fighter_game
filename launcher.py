...
pygame.display.set_caption("Pixel Fighter v5.3 - Mode Select")
...
class Button:
    ...
    def draw(self, mouse_pos: tuple[int, int]) -> None:
        ...
        image = font_mid.render(
            self.text,
            True,
            BLACK if color == CYAN else WHITE,
        )
